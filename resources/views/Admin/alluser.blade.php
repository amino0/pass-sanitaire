				...
				<div class="app-content">
					<div class="side-app">
						...
						<div class="page-header">
							<div>
								<h1 class="page-title">Voir Tout les utilisateur de l'ecosysteme </h1>
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#">Admin</a></li>
									<li class="breadcrumb-item active" aria-current="page">Tout le monde</li>
								</ol>
							</div>
							<div class="ms-auto pageheader-btn">
								...
								<a href="#" class="btn btn-success btn-icon text-white">
									...
									</span> Ajouter un nouveau utilisateur
								</a>
							</div>
						</div>
						<!-- PAGE-HEADER END -->
											...
											<table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom  w-100">
												...
												<tbody>
													...
													<tr>
														...
														<td><a href="{{url("/admin/user/$user->id")}}" class="btn btn-outline-warning">Voir plus </a>
                                                        </td>
													</tr>
                                                    @endforeach													
												</tbody>
